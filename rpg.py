...
postacie = [[200, 60, 0, 15],[230, 70, 0, 0],[170, 50, 100, 40],[120, 70, 10, 20], [150, 30, 200, 20], [150, 50, 140, 20], [120, 40, 30, 35], [999999999, 999999999, 999999999, 999999999]]
nazwyPostaci = ["Wojownik" , "Barbarzyńca" , "Paladyn" , "Łucznik" , "Mag Światła" , "Mag Ciemności" , "Bandyta" , "BÓG"]
#poziom trudności
poziom = 0
...
#wybierasz se postać  "Barbarzyńca" , "Paladyn" , "Łucznik"
def wyborPostac():
...
def bossZaklecia():
    ...
    print("    2 ────► Mega Heal                      +90 hp     -100 many)")
    print("    3 ────► Boost              +30 dmg     +10 hp      -30 many)")
    print("    4 ────► Super Boost      +1000 dmg    +100 hp     -400 many)")
    print("◄►───────────────────────────────────────────────────────────────────────◄►")
    z = getIntFromConsole()
    if z == 1:
        heal()
